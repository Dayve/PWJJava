...
CREATE TABLE TESTY (
	...
	JEDNOKROTNY_WYBOR NUMBER(1) NOT NULL,
...
CREATE OR REPLACE PROCEDURE add_test (
	...
	singleChoice IN TESTY.JEDNOKROTNY_WYBOR % TYPE,
...
BEGIN
	...
	INSERT INTO TESTY (ID_TESTU, NAZWA_TESTU, OPIS_TESTU, LICZBA_PYTAN, LICZBA_ODPOWIEDZI, JEDNOKROTNY_WYBOR, CZAS_ROZPOCZECIA, CZAS_ZAKONCZENIA, ID_KAT)
	VALUES (null, testName, description, numberOfQuestions, numberOfAnswers, singleChoice, to_date(startTime,'YYYY-MM-DD HH24:MI'), to_date(endTime,'YYYY-MM-DD HH24:MI'), testsCategoryID)    
...
INSERT INTO PYTANIA (ID_PYT, TRESC, ID_KAT)
VALUES (null, 'Pierwsze pytanie', 1);
INSERT INTO PYTANIA (ID_PYT, TRESC, ID_KAT)
VALUES (null, 'Drugie pytanie', 1);
INSERT INTO PYTANIA (ID_PYT, TRESC, ID_KAT)
VALUES (null, 'Trzecie pytanie', 1);
INSERT INTO PYTANIA (ID_PYT, TRESC, ID_KAT)
VALUES (null, 'Czwarte pytanie', 1);
INSERT INTO PYTANIA (ID_PYT, TRESC, ID_KAT)
VALUES (null, 'Piąte pytanie', 1);

INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 1 na pyt 1 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 2 na pyt 1 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 3 na pyt 1 dobra', 1);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 4 na pyt 1 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)

VALUES (null, 'Odp 1 na pyt 2 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 2 na pyt 2 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 3 na pyt 2 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 4 na pyt 2 dobra', 1);

INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 1 na pyt 3 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 2 na pyt 3 dobra', 1);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 3 na pyt 3 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 4 na pyt 3 zła', 0);

INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 1 na pyt 4 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 2 na pyt 4 dobra', 1);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 3 na pyt 4 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 4 na pyt 4 zła', 0);

INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 1 na pyt 5 dobra', 1);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 2 na pyt 5 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 3 na pyt 5 zła', 0);
INSERT INTO ODPOWIEDZI (ID_ODP, TRESC, POPRAWNOSC)
VALUES (null, 'Odp 4 na pyt 5 zła', 0);

INSERT INTO PYTANIE_ODPOWIEDZI (ID_PYT, ID_ODP)
VALUES (1, 1);
INSERT INTO PYTANIE_ODPOWIEDZI (ID_PYT, ID_ODP)
VALUES (1, 2);
INSERT INTO PYTANIE_ODPOWIEDZI (ID_PYT, ID_ODP)
